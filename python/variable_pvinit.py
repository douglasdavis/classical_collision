...
dx_vs_pvinit.GetXaxis().SetTitleOffset(.95)
dx_vs_pvinit.Draw('AP')
c2 = ROOT.TCanvas()
el_vs_pvinit.GetXaxis().SetTitleOffset(.95)
el_vs_pvinit.Draw('AP')
c3 = ROOT.TCanvas()
vfp_vs_pvinit.GetXaxis().SetTitleOffset(.95)
vfp_vs_pvinit.Draw('AP')
c4 = ROOT.TCanvas()
vft_vs_pvinit.GetXaxis().SetTitleOffset(.95)
